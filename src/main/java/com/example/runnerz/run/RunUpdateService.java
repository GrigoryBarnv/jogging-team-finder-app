...
public class RunUpdateService {
    ...
    public RunUpdateService(JdbcClientRunRepository runRepository, RunOwnershipService runOwnershipService) {
        this.runRepository = runRepository;
        this.runOwnershipService = runOwnershipService;
    }

    public void update(Run run, Integer id, OAuth2User user) {
